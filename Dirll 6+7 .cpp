...
try {
	cout<<"Welcome to our simple calculator. Pleace enter expression using floating-point number number .\n";
	cout<<"You can ues :'x' ,'-' ,'*' ,'/',and '%'.Enter X to quite . \n";
	cout<<"Enter '='when to solve your input .\n";
